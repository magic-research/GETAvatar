...
@click.option('--use_deformation', help='If true, use offset deformation for canonical mapping.', metavar='BOOL', type=bool, default=False)
def main(**kwargs):
    init_dist()
    ...
    c.G_kwargs.use_deformation = opts.use_deformation
