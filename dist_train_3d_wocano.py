...
def main(**kwargs):
    ...
    c.D_kwargs = dnnlib.EasyDict(
        class_name='training.networks_get3d_wocano.Discriminator', block_kwargs=dnnlib.EasyDict(),
    ...
    c.G_kwargs.class_name = 'training.networks_get3d_wocano.GeneratorDMTETMesh'
