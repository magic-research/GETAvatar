...
from training import animate_3d
...
@click.option('--white_bg', type=bool, help='use white background or not', default=False, show_default=True)
...
def main(**kwargs):
    ...
    c.action_dir = opts.action_dir
    c.action_type = opts.action_type
    c.frame_skip = opts.frame_skip
